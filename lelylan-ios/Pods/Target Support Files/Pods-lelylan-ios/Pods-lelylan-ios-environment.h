...
// DLLog
#define COCOAPODS_POD_AVAILABLE_DLLog
#define COCOAPODS_VERSION_MAJOR_DLLog 1
#define COCOAPODS_VERSION_MINOR_DLLog 0
#define COCOAPODS_VERSION_PATCH_DLLog 1

// FDKeychain
#define COCOAPODS_POD_AVAILABLE_FDKeychain
#define COCOAPODS_VERSION_MAJOR_FDKeychain 1
#define COCOAPODS_VERSION_MINOR_FDKeychain 0
#define COCOAPODS_VERSION_PATCH_FDKeychain 1
